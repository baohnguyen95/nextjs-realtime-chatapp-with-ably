...
export default function Home() {
  return (
    <div className="container">
      ...
      <main>
        <h1 className="title">Next.js Chat</h1>
        <Chat />
      </main>
      <footer>
        ...
        <a href="https://github.com/baohnguyen95/nextjs-realtime-chatapp-with-ably" className="github-corner" aria-label="View source on GitHub">
